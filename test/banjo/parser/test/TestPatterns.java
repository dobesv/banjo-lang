...
public class TestPatterns {
	...
	@Test public void testUnpackObject7() { test("({x=[y]}) -> y", "(y) -> ((y) -> ((y) -> y)(y.get(0)))(y.x)"); }
	...
	@Test public void testUnpackList1() { test("([y]) -> y", "(y) -> ((y) -> y)(y.get(0))"); }
	@Test public void testUnpackList2() { test("([x,y,z]) -> z", "(x) -> ((x, y, z) -> z)(x.get(0), x.get(1), x.get(2))"); }
	@Test public void testUnpackList3() { test("([x,{z}]) -> z", "(x) -> ((x, z) -> ((z) -> z)(z.z))(x.get(0), x.get(1))"); }
	@Test public void testUnpackList4() { test("[y] -> y", "(y) -> ((y) -> y)(y.get(0))"); }
	@Test public void testUnpackList5() { test("[x,y,z] -> z", "(x) -> ((x, y, z) -> z)(x.get(0), x.get(1), x.get(2))"); }
	@Test public void testUnpackListUsingAssignment() { test("([x,y,z] = foo ) => z", "((x) -> ((x, y, z) -> z)(x.get(0), x.get(1), x.get(2)))(foo)"); }

	@Test public void testUnpackLazy1() { test("(-> z) -> z", "(z) -> ((z) -> z)(z())"); }
	@Test public void testUnpackLazy2() { test("(-> {z}) -> z", "(z) -> ((z) -> ((z) -> z)(z.z))(z())"); }
	@Test public void testUnpackLazy3() { test("(-> [z]) -> z", "(z) -> ((z) -> ((z) -> z)(z.get(0)))(z())"); }
