	...
	public static Value callJavaObject(Value recurseFunction,
		...
		try {
	        ...
	        if(f instanceof Function) {
	        	return OverloadedJavaMethodCaller.callJavaMethod(f, instanceMethodsWithName(f.getClass(), "apply"), args.take(1));
	        }
	        ...
	        if(f instanceof Class) {
	        	...
	        	return OverloadedJavaMethodCaller.callJavaMethod(null, ((Class<?>)f).getConstructors(), args);
	        }
