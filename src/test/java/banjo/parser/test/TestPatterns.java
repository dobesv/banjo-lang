...
public class TestPatterns {
	...
	@Test public void testUnpackObject1() { test("({x}) -> x", "(__0) ↦ ((x = __0.x) ⇒ x)"); }
	@Test public void testUnpackObject2() { test("({x,y,z}) -> z", "(__0) ↦ ((x = __0.x, y = __0.y, z = __0.z) ⇒ z)"); }
	...
	@Test public void testUnpackObject5() { test("({x=y}) -> y", "(__0) ↦ ((y = __0.x) ⇒ y)"); }
	@Test public void testUnpackObject6() { test("({x={y}}) -> y", "(__0) ↦ ((y = __0.x.y) ⇒ y)"); }
	@Test public void testUnpackObject8() { test("{x} -> x", "(__0) ↦ ((x = __0.x) ⇒ x)"); }
	@Test public void testUnpackObject9() { test("{x,y,z} -> z", "(__0) ↦ ((x = __0.x, y = __0.y, z = __0.z) ⇒ z)"); }
