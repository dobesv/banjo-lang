...
public class TestCoreLibraryExamples extends BaseExprTest {
    private CoreExpr withoutScope;

    public TestCoreLibraryExamples(CoreExpr expr, CoreExpr withoutScope) {
        this.expr = expr;
    ...
    public static List<Object[]> parameters() {
        return findAllExamples().map(x -> new Object[] { x, TestAndExampleGatherer.stripScope(x) });
    }
